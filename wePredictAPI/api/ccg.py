...
class CCG_Data(Resource):
  ...
  def get(self,ccg_id):
    ...
    data = g.db.getResultParamaters("SELECT Practice_Name, "
                                    ...
                                    "(2009_Asthma_Value) as 2009_ASTHMA,"
                                    "(2009_Asthma_Upper) as 2009_ASTHMA_Upper,"
                                    "(2009_Asthma_Lower) as 2009_ASTHMA_Lower,"
                                    "(2010_Asthma_Value) as 2010_ASTHMA,"
                                    "(2010_Asthma_Upper) as 2010_Asthma_Upper,"
                                    "(2010_Asthma_Lower) as 2010_Asthma_Lower,"
                                    "(2011_Asthma_Value) as 2011_ASTHMA,"
                                    "(2011_Asthma_Upper) as 2011_ASTHMA_Upper,"
                                    "(2011_Asthma_Lower) as 2011_ASTHMA_Lower,"
                                    "(2012_Asthma_Value) as 2012_ASTHMA,"
                                    "(2012_Asthma_Upper) as 2012_Asthma_Upper,"
                                    "(2012_Asthma_Lower) as 2012_Asthma_Lower "
